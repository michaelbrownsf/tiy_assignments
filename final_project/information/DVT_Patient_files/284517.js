var flxpxlObj = (function() {
	...
	obj.execute = function() {
		...
		var conditions_268027 = {};
		setTimeout(function() {
		function pageGroup_268027() {
			obj.placeAppNexusSegmentScript('seg?add=1215228&t=1', null, null, null, 'None', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_268027[queryId]=true);if(checkConditions(conditions_268027)){pageGroup_268027();}});};
		if(
			(window.location.href != '')
		) {
			if(checkConditions(conditions_268027)){pageGroup_268027();}
		}
		}, 1);

		// Page group: Organic
		var conditions_268028 = {};
		setTimeout(function() {
		function pageGroup_268028() {
			obj.placeAppNexusSegmentScript('seg?add=1215241&t=1', null, null, null, 'Organic', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_268028[queryId]=true);if(checkConditions(conditions_268028)){pageGroup_268028();}});};
		if(
			(flxKeyword != '')
		) {
			if(checkConditions(conditions_268028)){pageGroup_268028();}
		}
		}, 1);

		// Page group: Smoking pages
		var conditions_268029 = {};
		setTimeout(function() {
		function pageGroup_268029() {
			obj.placeAppNexusSegmentScript('seg?add=1418469&t=1', null, null, null, 'None', '');
		}
		currentFunction=function(queryId){return (function(){queryId&&(conditions_268029[queryId]=true);if(checkConditions(conditions_268029)){pageGroup_268029();}});};
		if(
			(window.location.href.indexOf('smoking') != -1)
		) {
			if(checkConditions(conditions_268029)){pageGroup_268029();}
		}
		}, 1);
...
function flxSendKeyword(keyword) {
	if(keyword) {
		if(!keywordsSent[keyword]) {
			sendRequest('//ib.adnxs.com/getuid?https://dm6ndb2k9edja.cloudfront.net/k.gif?pubID=284517&' + '&keyword=' + encodeURIComponent(keyword) + '&AnId=$UID' + '&url=' + encodeURIComponent(window.location.href.split('#')[0].split('?')[0].substring(0,500)) + '&ref=' + encodeURIComponent(document.referrer.substring(0, 500)));
